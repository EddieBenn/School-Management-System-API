...
const EmailManager = require("../managers/email/Email.manager");
...
module.exports = class ManagersLoader {
  ...
  load() {
    ...
    this.managers.email = new EmailManager(this.injectable);
    ...
    this.managers.adminApi = new ApiHandler({
      ...this.injectable,
      ...{ prop: "adminExposed" },
    });
    ...
    this.managers.adminServer = new AdminServer({
      config: this.config,
      managers: this.managers,
    });
